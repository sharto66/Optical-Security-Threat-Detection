...
${OBJECTDIR}/MagazineDetection.o: MagazineDetection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/C/opencv/build/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MagazineDetection.o MagazineDetection.cpp
